...
const main = async () => {
  ...
  await prisma.medicalResume.upsert({
    ...
    create: {
      ...
      visitId: visit3.id,
      patientId: patient3.id,
      admissionReason: 'Gagal jantung kongestif dengan sesak napas berat',
      clinicalSummary: 'Pasien laki-laki 58 tahun datang dengan keluhan sesak napas sejak 1 minggu. Edema tungkai +, distensi vena jugularis +. Dilakukan pemeriksaan EKG dan Echo dengan hasil disfungsi ventrikel kongestif.',
      diagnosticResults: 'EKG: Ritme sinus, LVH. Echo: EF 35%, dilatasi seluruh ruang. Laboratorium: BNP 450 pg/mL, Kreatinin 1.8 mg/dL',
      mainDiagnosis: 'Gagal jantung kongestif NYHA III',
      secondaryDiagnoses: 'Hipertensi derajat 2, CKD stadium 3',
      procedures: 'Katerisasi jantung rencana 24 jam',
      drugsDuringStay: 'Furosemide 40mg 2x sehari, Spironolakton 25mg 1x sehari, Bisoprolol 5mg 1x sehari, ACE Inhibitor',
      homeMedications: 'Lanjut obat jantung, Kontrol rutin 1 minggu',
      prognosis: 'Dengan terapi optimal, prognosis quoad vitam baik, quoad restitution ad integram dubia',
      followUpPlan: '1. Poliklinik jantung 1 minggu\n2. Laboratorium fungsi ginjal 3 hari\n3. Echo follow-up 1 bulan',
      doctorInChargeId: drBudi.id,
    },
  });
  ...
  await prisma.medicalResume.upsert({
    ...
    create: {
      ...
      visitId: visit5.id,
      patientId: patient5.id,
      admissionReason: 'Evaluasi cedera olahraga pada lutut kanan',
      clinicalSummary: 'Pasien laki-laki 35 tahun dengan riwayat cedera lutut kanan berulang. Kali ini terkilir saat bermain futsal. Dilakukan pemeriksaan fisik dan MRI.',
      diagnosticResults: 'MRI lutut: Robekan ligamen anterior cruciate grade 2, meniskus medial intact. LGS -',
      mainDiagnosis: 'Sprain ligamen anterior cruciate lutut kanan grade 2',
      secondaryDiagnoses: 'Cedera meniskus medial grade 1',
      procedures: 'Konservatif dengan fisioterapi intensif',
      drugsDuringStay: 'Ibuprofen 400mg 3x sehari, Vitamin D 1000 IU 1x sehari',
      homeMedications: 'Lanjut NSAID 5 hari, Latihan fisioterapi di rumah',
      prognosis: 'Prognosis baik dengan fisioterapi adekuat, dapat kembali beraktivitas normal dalam 6-8 minggu',
      followUpPlan: '1. Fisioterapi 3x seminggu selama 4 minggu\n2. Kontrol MRI 6 minggu\n3. Evaluasi kembali berolahraga setelah 3 bulan',
      doctorInChargeId: drSiti.id,
    },
  });
